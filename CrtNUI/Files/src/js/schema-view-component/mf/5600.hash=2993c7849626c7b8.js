...
`]}]}],function(){return[]},{disableAlpha:[{type:e.Input}],presetColors:[{type:e.Input}],width:[{type:e.Input}]});class u{static \u0275fac=function(n){return new(n||u)};static \u0275mod=e.\u0275\u0275defineNgModule({type:u});static \u0275inj=e.\u0275\u0275defineInjector({imports:[p.CommonModule,a.AlphaModule,a.CheckboardModule,a.EditableInputModule,a.HueModule,a.SaturationModule,a.SwatchModule]})}(typeof ngDevMode>"u"||ngDevMode)&&e.\u0275setClassMetadata(u,[{type:e.NgModule,args:[{declarations:[i,c,h],exports:[i,c,h],imports:[p.CommonModule,a.AlphaModule,a.CheckboardModule,a.EditableInputModule,a.HueModule,a.SaturationModule,a.SwatchModule]}]}],null,null)}}]);
